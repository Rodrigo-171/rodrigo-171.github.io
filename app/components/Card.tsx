            ...
            <div className="opacity-100 mb-0 duration-500 transition-all" data-aos="fade-up">
                <div className="cursor-pointer bg-zinc-200 hover:bg-zinc-300 dark:bg-zinc-700 dark:hover:bg-zinc-600 transition-600 rounded-xl flex flex-col px-6 py-4 gap-3 border-solid border border-zinc-300  dark:border-zinc-500 min-w-[calc(260px)]">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mb-4 mt-5">
                            <Image width={27} height={27} className="w-[calc(27px)] rounded-md" src="/images/html-svg.svg" alt="HTML Logo" />
                            <Image width={27} height={27} className="w-[calc(27px)] rounded-md" src="/images/css3-svg.svg" alt="CSS Logo" />
                            <Image width={27} height={27} className="w-[calc(27px)] rounded-md" src="/images/js-svg.svg" alt="JavaScript Logo" />
                        </div>
                        <Image width={150} height={100} className="rounded-lg w-full h-auto" src="/images/imovi.png" alt="banner Imovi" />
                        <div className="flex w-full pt-2 gap-2 justify-center">
